    ...
    lessons: [
      {
        ...
        content: 'https://www.youtube.com/watch?v=cLKCDaNRHW0',
...
export default function TestCourseDetailPage() {
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-8 overflow-hidden shadow-lg">
              {/* Video Preview */}
              <div className="relative flex h-64 items-center justify-center bg-gradient-to-br from-teal-400 to-blue-600">
                <div className="text-center">
                  ...
                  <div className="text-xl font-medium text-white">nâng cao</div>
                </div>
                <Button className="absolute bottom-4 left-1/2 -translate-x-1/2 rounded-full bg-white/90 px-6 font-medium text-teal-600 hover:bg-white">
              ...
              <CardContent className="p-6">
                <div className="mb-6 text-center">
                  ...
                  <Button className="w-full rounded-full bg-blue-500 py-6 text-base font-semibold text-white hover:bg-blue-600">
                    ĐĂNG KÝ HỌC
                  </Button>
                </div>
