                        ...
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                          ...
                          <div className="flex flex-1 gap-3">
                            ...
                            <div className="flex-1 space-y-2">
                              ...
                              {/* Timeline */}
                              <div className="space-y-1.5 border-l-2 border-gray-100 pl-3 pt-2 text-xs">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            className="shrink-0 text-orange-600 transition-all hover:bg-orange-50 hover:text-orange-700"
                            onClick={() => {
                              console.log('View user:', userCourse.userId);
                              navigate(`/admin/users/${userCourse.userId}`);
                            }}
                          >
